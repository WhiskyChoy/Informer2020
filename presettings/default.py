...
parser.add_argument('--scale', type=bool, default=True, help='Use scale for data. Strongly recommended to set it True.')
parser.add_argument('--test_recover', type=bool, default=False, help='scale the output of testing to be normal')
parser.add_argument('--predict_recover', type=bool, default=False, help='scale the output of predicting to be normal')
